...
public class ManBaActivity extends AppCompatActivity {

    private RecyclerView recyclerViewTimSo;
    private ManBaAdapter manBaAdapter;
    ...
    private void setEvent() {
        ...
        txtChoiLai.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                SoundManager.playButton(context);
                chuyenManHinh(ManBaActivity.class);
            }
        });
    ...
    private void khoiTao() {
        ...
        manBaAdapter = new ManBaAdapter(this, timSoList);
        recyclerViewTimSo.setLayoutManager(new GridLayoutManager(this, 4));
        recyclerViewTimSo.setAdapter(manBaAdapter);
        ...
        int soMangCon = manBaAdapter.getMangChoi();
        ...
        manBaAdapter.setMangSongList(mangSongList);
        manBaAdapter.setMangSongAdapter(mangSongAdapter);
    }
